...
static struct dsi_cmd_desc samsung_oled_hd_display_on3_cmds[] = {
...
static void mipi_samsung_id_callback(u32 data)
{
	int i;

        manu_id = data;
        printk("[%s] manufacture_id=0x%x\n", __func__, manu_id);
        ...
        for(i=0; i<3;i++)
        {
                ...
                {
                    prev_id2 = ((manu_id&(0xff00)) >> 8);
                    printk("[PANTECH_LCD]OLED Rev.(ID2) = 0x%x\n",prev_id2);
                }
                else if(i==2){
                    elvss_id3 = ((manu_id&(0xff0000)) >> 16);;
...
//        cmdreq.rlen = 3;
        cmdreq.rlen = 4;
        cmdreq.cb = mipi_samsung_id_callback; /* call back */
...
void is_oled_temp_check(struct work_struct *work)
{
	...
	if(result.physical > 42 ) 
	{
		...
		if((samsung_oled_hd_state.disp_on == true) && (is_high_bk == true) && (is_set == true))
		{
	   		...
	   		mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_11,
	...
	}else if((result.physical < 38) && (is_temp == 1))
	{
		...
		if( (samsung_oled_hd_state.disp_on == true) && (is_high_bk == true) && is_set == false)
		{
			...
			{
			case 15:
			   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_15,
					ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_15));
			break;
			case 14:
			   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_14,
					ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_14));
			break;
			case 13:
			   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_13,
					ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_13));
			break;
			case 12:
	  		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_12,
...
// 	    	msleep(10);
                ...
                cmdreq.cmds = samsung_oled_hd_display_init_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_init_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else		
            mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_init_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_on2_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_on2_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
	 	  	mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_on2_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_15;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_15);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_1;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_1);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
	  			mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_1,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_on3_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_on3_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
	   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_on3_cmds,
                  ARRAY_SIZE(samsung_oled_hd_display_on3_cmds));
#endif
#ifdef CONFIG_ACL_FOR_AMOLED
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_acl_control55_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_acl_control55_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
					mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf,samsung_oled_hd_display_acl_control55_cmds ,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_acl_control53_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_acl_control53_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
					mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_acl_control53_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_acl_control52_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_acl_control52_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
					mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_acl_control52_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_acl_control50_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_acl_control50_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
					mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_acl_control50_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_acl_control48_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_acl_control48_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
					mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_acl_control48_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_acl_control45_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_acl_control45_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
					mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_acl_control45_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_acl_control43_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_acl_control43_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
					mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_acl_control43_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_acl_control30_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_acl_control30_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
					mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_acl_control30_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_acl_control10_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_acl_control10_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
					mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_acl_control10_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_acl_on_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_acl_on_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
                mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf,samsung_oled_hd_display_acl_on_cmds,
                                                        ARRAY_SIZE(samsung_oled_hd_display_acl_on_cmds));
#endif
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_acl_off_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_acl_off_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
                mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_acl_off_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_elvss300_210_id3_1_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_elvss300_210_id3_1_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
   			mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_elvss300_210_id3_1_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_elvss200_170_id3_1_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_elvss200_170_id3_1_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
   			mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_elvss200_170_id3_1_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_elvss160_110_id3_1_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_elvss160_110_id3_1_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
   			mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_elvss160_110_id3_1_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_elvss100_000_id3_1_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_elvss100_000_id3_1_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
   			mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_elvss100_000_id3_1_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_elvss300_210_id3_0_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_elvss300_210_id3_0_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
			mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_elvss300_210_id3_0_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_elvss200_170_id3_0_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_elvss200_170_id3_0_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
			mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_elvss200_170_id3_0_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_elvss160_110_id3_0_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_elvss160_110_id3_0_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
			mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_elvss160_110_id3_0_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_elvss100_000_id3_0_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_elvss100_000_id3_0_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
			mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_elvss100_000_id3_0_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_wakeup_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_wakeup_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
...
//	}
	...
	if(is_sleep && samsung_oled_hd_state.disp_on )
	{
                ...
                mipi_dsi_cmdlist_put(&cmdreq);
#else
          mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_wakeup_cmds,
                   ARRAY_SIZE(samsung_oled_hd_display_wakeup_cmds));
#endif
		   printk("[PANTECH_LCD:%s] wakeup state (oled_hd panel).... \n",__func__);
	}
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_14;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_14);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_13;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_13);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_12;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_12);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_11;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_11);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_10;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_10);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_10,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_9;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_9);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_9,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_8;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_8);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_8,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_7;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_7);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_7,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_6;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_6);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_6,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_5;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_5);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_5,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_4;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_4);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_4,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_3;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_3);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_3,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_2;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_2);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_2,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_screen_off_cmds;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_screen_off_cmds);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
	            mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_screen_off_cmds,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_29;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_29);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_29,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_28;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_28);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_28,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_27;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_27);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_27,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_26;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_26);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_26,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_25;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_25);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_25,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_24;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_24);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx( &samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_24,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_23;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_23);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_23,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_22;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_22);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_22,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_21;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_21);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_21,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_20;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_20);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_20,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_19;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_19);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_19,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_18;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_18);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_18,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_17;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_17);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_17,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_display_gamma_cmds_level_16;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_display_gamma_cmds_level_16);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
		   mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_display_gamma_cmds_level_16,
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_gpara11_cmd;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_gpara11_cmd);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else	
	mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_gpara11_cmd, 
...
#ifdef CONFIG_F_SKYDISP_FIX_DMA_TX_FAIL
	     		memset(&cmdreq, 0, sizeof(cmdreq));
                cmdreq.cmds = samsung_oled_hd_gpara21_cmd;
                cmdreq.cmds_cnt = ARRAY_SIZE(samsung_oled_hd_gpara21_cmd);
                cmdreq.flags = CMD_REQ_COMMIT;
                cmdreq.rlen = 0;
                cmdreq.cb = NULL;
                mipi_dsi_cmdlist_put(&cmdreq);
#else
	mipi_dsi_cmds_tx(&samsung_oled_hd_tx_buf, samsung_oled_hd_gpara21_cmd, 
