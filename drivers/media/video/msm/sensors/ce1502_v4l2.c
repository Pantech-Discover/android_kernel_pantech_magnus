...
#define CE1502_FW_MINOR_VER	24 //23
#define CE1502_PRM_MAJOR_VER	55
#define CE1502_PRM_MINOR_VER	24 //23
#endif
...
#ifdef T_MAGNUS   // Magnus Preview rotation 180'
    data_buf[0] = 0x03;	
    rc = ce1502_cmd(s_ctrl, 0xAE, data_buf, 1);
#endif
